...
;      next warm boot
;
; PICOVERSE also implements the F2 device
...
PATCH2:
    ld  (hl),#C9
    inc hl
    djnz    PATCH2                  ; So patch all 11 bytes with return
...
WELCOME:
    db  CLS
    db  "PICOVERSE TCP/IP UNAPI 1.3"      ,CR,LF
...
APIINFO:                db  "PICOVERSE Wi-Fi UNAPI",0
...
BUILD_DATE:             db  "BUILD 2026/04/23"
